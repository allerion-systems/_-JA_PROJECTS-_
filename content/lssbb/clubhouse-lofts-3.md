# Clubhouse Lofts Bldg No. 3 — Lean Six Sigma Black Belt Case Study

**Year:** 2020  **Employer:** American Roofing & Metal, Inc  **Location:** 2330 Crittenden Dr, Louisville, KY 40217  **Budget:** $500,000  **Role:** Estimator / PM  **Status:** Completed

## Define
Clubhouse Lofts Bldg No. 3 was a commercial roofing engagement delivered by American
Roofing & Metal, Inc. at 2330 Crittenden Dr, Louisville, KY 40217, awarded at a contract value of
$500,000 in 2020. As Estimator/PM, Joey scoped and/or
priced the work and managed it from award through closeout. The recorded scope here is specifically "Thermal & Moisture Remediation" rather than a full tear-off/replace — remediation of an existing moisture/thermal-performance failure in an occupied apartment building, which raises the stakes on interior water-intrusion control since the failure being remediated may already have residents dealing with active or recent moisture issues. The
project charter for this job class centers on an occupied or soon-to-be-occupied multifamily/hospitality building where residents, guests, or a leasing timeline sit directly below the work: replace or
...
## Analyze
The dominant root causes on occupied residential/hospitality reroofs are disruption management, not roofing technique: noise and dust windows that have to be communicated to residents or guests in advance, interior water-intrusion risk during tear-off (a leak here is a life-safety/property-damage event, not just a punch-list item), and constrained staging/parking on an urban lot that competes with tenant or guest parking.

## Improve
A resident/guest notification protocol tied to the phased tear-off schedule, nightly dry-in verification before crews leave any section open, and a staging plan negotiated with property management before mobilization instead of worked out ad hoc on day one.
...
hospitality-type job rather than being re-learned from scratch.
