/**
 * Misty Valley Supply — MCP server (Deno / Supabase Edge Function port).
 *
 * Ported from src/server.js. Exposes the construction safety catalog to
 * agents, with one tool nobody else has: check_compliance, which answers
 * "what does OSHA require for this hazard, and what satisfies it" — because
 * the catalog carries the standard and the citation as structured data
 * rather than marketing copy.
 *
 * The catalog is bundled into the function via a JSON module import.
 */
