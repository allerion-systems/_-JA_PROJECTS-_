  ...
  if (!user) return (
    <Panel className="mx-auto max-w-[520px] card-hi text-center" pad={false}>
      ...
      <div className="p-6">
        ...
        <p className="mx-auto mt-3 max-w-[42ch] text-[13px] leading-[1.55] text-[hsl(var(--ink-2))]">
    ...
    <div>
      ...
      <div className="mb-5 card-hi">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4 p-4 sm:p-5">
          <div>
            ...
            <h1 className="disp text-[28px] font-bold leading-none sm:text-[40px]">{user.company}</h1>
            <div className="mt-2 text-[13px] text-[hsl(var(--ink-2))]">
        ...
        <div className="grid gap-px border-t border-[hsl(var(--rule))] bg-[hsl(var(--rule))] sm:grid-cols-4">
          {[
            ...
            <div key={k} className="bg-[hsl(var(--panel))] p-4">
              ...
              <div className={cx("disp text-[22px] font-bold leading-none",
          ...
          <Panel pad={false}>
            <DataTable
              ...
              rows={INVOICES.map(i => [
                ...
                <span className="text-[13px] text-[hsl(var(--ink-3))]">{i.order}</span>,
                <span className="text-[13px]">{i.date}</span>,
      ...
      {tab === "Lists" && (
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {LISTS.map(l => (
            <Panel key={l.name}>
              <div className="disp text-[18px] font-semibold leading-[1.1]">{l.name}</div>
              <div className="mt-1.5 text-[11px] text-[hsl(var(--ink-3))]">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {user.shipTos.map(s => (
            <Panel key={s.id}>
              ...
              <div className="mt-1.5 text-[13px] text-[hsl(var(--ink-2))]">{s.addr}</div>
              <Rule className="my-3" />
