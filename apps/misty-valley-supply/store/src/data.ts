...
export const PRODUCTS: Product[] = [
  ...
  { sku: "MVS-IMP-R10", name: 'Insulated Metal Roof Panel — High-Rib, 1" PIR Core', cat: "roofing",
    price: 675, uom: "SQ", std: "26-ga Galvalume faces, PIR core", osha: "1926.501(b)(10) roof work", fulfil: "dropship",
    supplier: "US IMP manufacturer — Metl-Span/Kingspan lane", lead: "10-16 weeks", moq: 5,
    note: "Panel and insulation in one lift. Quoted per project cut list; freight quoted separately.",
    why: "One panel replaces roof sheet, insulation, and liner — the crew sets R-value and weather skin in the same pass. Thickness sets the R; the cut list sets the price." },
  { sku: "MVS-IMP-R15", name: 'Insulated Metal Roof Panel — High-Rib, 1.5" PIR Core', cat: "roofing",
    price: 745, uom: "SQ", std: "26-ga Galvalume faces, PIR core, ~R-13", osha: "1926.501(b)(10) roof work", fulfil: "dropship",
    supplier: "US IMP manufacturer — Metl-Span/Kingspan lane", lead: "10-16 weeks", moq: 5, hot: true,
    note: "The commercial re-roof workhorse thickness. Quoted per project cut list; freight quoted separately.",
    why: "1.5 inch is the spec on the live 455-square RFQ — only two US lines roll it, which is exactly why carrying it matters." },
  { sku: "MVS-IMP-R20", name: 'Insulated Metal Roof Panel — High-Rib, 2" PIR Core', cat: "roofing",
    price: 815, uom: "SQ", std: "26-ga Galvalume faces, PIR core, ~R-16", osha: "1926.501(b)(10) roof work", fulfil: "dropship",
    supplier: "US IMP manufacturer — Metl-Span/Kingspan lane", lead: "10-16 weeks", moq: 5,
    note: "Most makers' minimum roof core. Quoted per project cut list; freight quoted separately.",
    why: "Two inches opens every US IMP line to bid — spec 2 when the R works and the field gets competitive." },
  { sku: "MVS-IMP-R25", name: 'Insulated Metal Roof Panel — High-Rib, 2.5" PIR Core', cat: "roofing",
    price: 885, uom: "SQ", std: "26-ga Galvalume faces, PIR core, ~R-20", osha: "1926.501(b)(10) roof work", fulfil: "dropship",
    supplier: "US IMP manufacturer — Metl-Span/Kingspan lane", lead: "10-16 weeks", moq: 5,
    note: "Quoted per project cut list; freight quoted separately.",
    why: "The step between code-minimum and cold-storage duty — common on conditioned shops and ag processing." },
  { sku: "MVS-IMP-R30", name: 'Insulated Metal Roof Panel — High-Rib, 3" PIR Core', cat: "roofing",
    price: 950, uom: "SQ", std: "26-ga Galvalume faces, PIR core, ~R-24", osha: "1926.501(b)(10) roof work", fulfil: "dropship",
    supplier: "US IMP manufacturer — Metl-Span/Kingspan lane", lead: "10-16 weeks", moq: 5,
    note: "Quoted per project cut list; freight quoted separately.",
    why: "Conditioned warehouse duty — the thickness energy code pushes toward on new commercial roofs." },
  { sku: "MVS-IMP-R40", name: 'Insulated Metal Roof Panel — High-Rib, 4" PIR Core', cat: "roofing",
    price: 1095, uom: "SQ", std: "26-ga Galvalume faces, PIR core, ~R-32", osha: "1926.501(b)(10) roof work", fulfil: "dropship",
    supplier: "US IMP manufacturer — Metl-Span/Kingspan lane", lead: "10-16 weeks", moq: 5,
    note: "Cold-storage class. Quoted per project cut list; freight quoted separately.",
    why: "Freezer and cold-dock work lives here — thickest standard roof core before custom territory." },
  { sku: "MVS-SF-CP6", name: 'C-Purlin — 6" × 12 ft, 14-ga Galvanized', cat: "sheathing",
    price: 32, uom: "EA", std: "ASTM A653 G90", osha: "Engineered layout install", fulfil: "dropship",
    supplier: "Steel framing mill — KY/TN", lead: "1-2 weeks", moq: 10,
    note: "Structural roof purlin — return-lip C profile. Span tables per engineered layout.",
    why: "The stick between frame and roof sheet on every metal building. Purlin gauge and spacing come from the engineered layout, not from habit." },
  { sku: "MVS-SF-CP8", name: 'C-Purlin — 8" × 12 ft, 14-ga Galvanized', cat: "sheathing",
    price: 41, uom: "EA", std: "ASTM A653 G90", osha: "Engineered layout install", fulfil: "dropship",
    supplier: "Steel framing mill — KY/TN", lead: "1-2 weeks", moq: 10,
    note: "Structural roof purlin — return-lip C profile. Span tables per engineered layout.",
    why: "Longer bays want deeper purlins — 8 inch carries the span an engineered layout asks of it." },
