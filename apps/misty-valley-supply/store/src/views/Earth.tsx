  ...
  return (
    <div>
      <div className="mb-4 flex flex-wrap items-end justify-between gap-3 border-b border-[hsl(var(--ink))] pb-2">
        <div>
          <Lab className="mb-1.5 !text-[hsl(var(--safety))]">Job Site Earth</Lab>
      ...
      <div className="lg:grid lg:grid-cols-[1fr_320px] lg:gap-6">
        ...
        <aside className="mt-6 lg:mt-0">
          ...
          <Panel className="mt-4 border-l-2 border-l-[hsl(var(--safety))]">
            <Lab className="mb-2 !text-[hsl(var(--safety))]">Why this is the hook</Lab>
          ...
          {!person && (
            <Panel className="mt-3">
              <p className="text-[12.5px] leading-[1.5] text-[hsl(var(--ink-2))]">
                ...
                <button onClick={onSignIn} className="font-semibold text-[hsl(var(--safety))] underline">
                  sign in
                </button>.
              </p>
            </Panel>
      ...
      {shot && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/70 p-4"
          ...
          <div className="max-h-[90vh] w-full max-w-[420px] overflow-y-auto border-2 border-[hsl(var(--safety))] bg-[hsl(var(--ground))]"
            ...
            <div className="p-4">
              <Lab className="mb-1.5 !text-[hsl(var(--safety))]">Posting to {shot.site}</Lab>
