      ...
      <section className="card-hi mb-10">
        <div className="grid lg:grid-cols-[1.15fr_1fr]">
              ...
              <div className="mt-4 flex flex-wrap gap-x-5 gap-y-2">
                {[["Try", "1926.501"], ["or", "Z87+"], ["or", "cut level A4"]].map(([a, b]) => (
                  <button key={b} onClick={() => onSearch(b)} className="text-left">
                    ...
                    <span className="mono text-[13px] text-[hsl(var(--safety))] underline decoration-[hsl(var(--safety))]/50 underline-offset-2">{b}</span>
                  </button>
                ))}
              </div>
            </div>
          ...
          <div className="border-t border-[hsl(var(--rule))] p-5 sm:p-7 lg:border-l lg:border-t-0">
            ...
            <button onClick={onEarth} className="lab mt-3 text-[hsl(var(--safety))] underline underline-offset-2">
              Open Job Site Earth
            </button>
          </div>
        </div>
