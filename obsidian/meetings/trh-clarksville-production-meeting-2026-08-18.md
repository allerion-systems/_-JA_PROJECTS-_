# TRH Clarksville — Production Meeting Prep (Tue 8/18/2026)
...
## Where the panel order actually stands — searched 8/18 AM

**There is no written confirmation of anything, and Kyle never answered the email that placed the order.**

The paper trail, in order:

| Date | What happened |
|---|---|
| 8/5 | Field meeting flags panel shortage. Action item on you: "email a final, consolidated material list to Kyle." Notes also flag *no written confirmation for the ridge cap from QXO*, and two of six crew standing around waiting on material. |
| 8/6 | Field call: the Metal Sales delivery (ordered through QXO) came in **wrong** — double the 7' and 7'-6" pieces, **missing the 8-foot pieces**. Action item: get the delivery date for the correct material. |
| 8/6 13:29 | You email Kyle Raymer, subject **"Remaining Metal not on Job site"** with a photo: *"I don't know if this wasn't delivered or what but we are short these pieces. Get them on order asap and we will reconcile later today."* |
...
### Call Kyle before the meeting — Kyle Raymer, QXO, O: 502-635-6059, M: 502-565-5170

Ask, in this order:
1. Was the replacement order for the missing 8' pieces actually placed after my 8/6 email? Give me the order number.
2. What plant is it running at and what is the confirmed ship/delivery date? **Send it to me in writing today.**
3. Ready date on the gutter replacement metal being cut at Sellersburg.
4. Is anything on our account holding this release? (Scott raised the 60- vs 30-day commercial terms on 8/5 — *"I haven't been paid a dollar for the Texas Roadhouse"* — and you said 8/6 you were working it. There's also the $33,618.21 statement item open with April Stewart in credit.) **Confirm there is no credit hold sitting on this order.**

Reference numbers: QXO acct **590227**; PO **26-10349-01** and **26-10349-02**; material release **TRH Clarksville #292268**.

---

## This week's update — same format as last Tuesday's (send to Zach, cc Kathryn)
...
- [ ] **Kyle (QXO)** — the four questions above, written confirmation on the panel delivery
- [ ] **Coping fabricator** — written ship date for week of 8/24
- [ ] Fill the two brackets in the draft, send it, then walk into the meeting having already answered Kathryn

## In the meeting — quick hits

- **Don't oversell 8/20.** Nothing is confirmed in writing. If Kyle hasn't sent it by meeting time: "confirmed verbally, written confirmation expected today, I'll forward it."
- **Kathryn has been waiting since 8/11** on gutters + coping — lead with them.
- **Staging:** get Zach's delivery window and truck path on record for Wednesday.
- **Deltas 6, 7 & 8** (issued 8/12): confirm no roofing/sheet-metal scope changed before recommitting; flag CO if coping or gutter profiles moved.
...
- QXO: terms dispute open since 8/5; $33,618.21 statement item with April Stewart (credit). Real risk to the panel release — ask directly.
...
- Root cause is design/procurement: architects specified thin gauge with wide pans; Ethan (engineer) recommends 22-gauge and gets refused on budget
